...
# 项目启动jar包名称
APPLICATION_JAR="package-test.jar"
...
export APP_HOME="${BASE_PATH}"
#======================================================================
# 执行启动命令：后台启动项目,并将日志输出到项目根目录下的logs文件夹下
#======================================================================
nohup java ${JAVA_OPT} -jar ${BASE_PATH}/boot/${APPLICATION_JAR} --logging.config=${CONFIG_DIR}/logback.xml --spring.config.location=${CONFIG_DIR} > ${LOG_PATH} 2>&1 &
echo $! > "${BASE_PATH}/pid"
