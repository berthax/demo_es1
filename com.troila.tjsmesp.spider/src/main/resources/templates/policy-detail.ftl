            ...
            <div class="cLBox_w">
                ...
                <div class="cLBox_t_zy">
                    ...
                    <div class="blueBox mt20 clearfix">
                        ...
                        <#list relatedPolicyList as p>
                        	<#if p.type==0>
                        		<a class="btn_solid fl" style="margin-bottom:10px" href="/policy?uid=${user.userId}&aid=${p.id}">政策原文</a>
                        	<#elseif p.type==1>
                        		<a class="btn_solid fl" style="margin-bottom:10px" href="/policy?uid=${user.userId}&aid=${p.id}">政策摘编</a>
                        	<#else>
                        		<a class="btn_solid fl" style="margin-bottom:10px" href="/policy?uid=${user.userId}&aid=${p.id}">政策解读</a>
                        	</#if>
                        </#list>
                        </#if>
                ...
                <div class="recommend">
                    ...
                    <ul class="indexList_PJY">
                        ...
                        <li>
                            <a href="/policy?uid=${user.userId}&aid=${p.id}">
