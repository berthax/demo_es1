 ...
 *
 */
@Component("policyNewsRegionalDynamicPageProcessorSouSuoGov")
//public class PolicyNewsRegionalDynamicPageProcessor implements PageProcessor{
public class PolicyNewsRegionalDynamicPageProcessorSouSuoGov extends AbstractPolicyPageProcessor{
