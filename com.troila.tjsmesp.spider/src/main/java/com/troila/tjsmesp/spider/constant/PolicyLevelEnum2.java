...
//			'静海区','宁河区','蓟州区');
    ...
    // 构造方法  
    private PolicyLevelEnum2(String name, int level) {  
        this.name = name;  
        this.level = level; 
        this.alias = null;
    }
    private PolicyLevelEnum2(String name, int level,String alias) {  
        this.name = name;  
        this.level = level; 
        this.alias = alias;
    }
	...
	public static int getLevelByName(String name) {
        ...
        //先查看是否有真正对应的发文部门名称
    	for (PolicyLevelEnum2 p : PolicyLevelEnum2.values()) {  
