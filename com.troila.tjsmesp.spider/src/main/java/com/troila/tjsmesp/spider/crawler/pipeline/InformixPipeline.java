...
//	private PolicySpiderRepositoryInformix policySpiderRepositoryInformix;
	...
	public void process(ResultItems resultItems, Task task) {
		 ...
		 * if(policySpider == null) { //如果是列表页，没有此项内容 return; }
		 * 
		 * //筛选出内容中包含企业的政策来 //
		 * if(ContentFilter.filterWords(policySpider.getContent(),"企业")) { // return; //
		 * } //对原有记录进行更新，对新纪录进行保存 policySpiderRepositoryInformix.save(policySpider);
		 */
	}
