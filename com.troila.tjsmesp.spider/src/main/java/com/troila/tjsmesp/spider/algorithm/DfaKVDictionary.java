...
import com.troila.tjsmesp.spider.algorithm.node.WordNode;
import com.troila.tjsmesp.spider.util.PatternUtil;

public class DfaKVDictionary implements WordDictionary{
	private Map<Integer, WordNode> profanities = new HashMap<>(); //搜索词库
